...
profile phases are likewise deferred rather than silently treated as active.
...
wheelset inputs in \texttt{physical8\_v1} are idealized constrained-motion
acceleration proxies, not validated axle-box sensor observations.
