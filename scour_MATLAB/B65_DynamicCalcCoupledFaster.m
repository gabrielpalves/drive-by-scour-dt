function [Sol] = B65_DynamicCalcCoupledFaster(Veh,Model,Calc,Track,Sol,Damage)
...
for veh_num = 1:Veh(1).Tnum
    ...
    Sol.Veh(veh_num).A(1:6,:) = Sol.Veh(veh_num).A(1:6,:) + ...
        Damage.desvio*Sol.Veh(veh_num).A(1:6,:).*randn(6,length(Sol.Veh(veh_num).A(1,:)));
    Sol.Veh(veh_num).V(4:6,:) = Sol.Veh(veh_num).V(4:6,:) + ...
        Damage.desvio*Sol.Veh(veh_num).V(4:6,:).*randn(3,length(Sol.Veh(veh_num).V(1,:)));
%     Sol.Veh(veh_num).U(4:6,:) = Sol.Veh(veh_num).U(4:6,:) + ...
%         Damage.desvio*Sol.Veh(veh_num).U(4:6,:).*randn(3,length(Sol.Veh(veh_num).U(1,:)));
end % for veh_num = 1:Veh(1).Tnum
