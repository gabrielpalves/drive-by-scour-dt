...
if ~isstruct(environment_lock) || ~isscalar(environment_lock) || ...
        ...
        ~strcmp(environment_lock.schema, 'ttbi-campaign-environment-v3') || ...
...
if ~strcmp(actual_environment_sha256, campaign_environment_sha256)
    warning('F25_Run:ReferenceMATLABEnvironmentDiffers', ...
        ['This host differs from the known-good MATLAB reference %s (%s): ' ...
         'actual %s (%s). Continuing after local capability qualification; ' ...
    ...
    fprintf('[F25] MATLAB environment %s (%s; known-good reference).\n', ...
        actual_environment_sha256, actual_environment.release);
end

[source_root_sha256, source_digest_lines, source_file_count] = ...
    generator_source_root();
bundle_binding = ttbi.f25_bundle_source_binding( ...
    repository_root, source_root_sha256, source_digest_lines, ...
...
provenance.bundle_source_binding_schema = bundle_binding.schema;
provenance.bundle_source_binding_sha256 = bundle_binding.sha256;
provenance.bundle_source_commit = bundle_binding.source_commit;
provenance.bundle_source_manifest_sha256 = ...
    bundle_binding.source_manifest_sha256;
provenance.bundle_source_root_sha256 = ...
    bundle_binding.bundle_source_root_sha256;
provenance.f25_r_bundle_manifest_file_sha256 = ...
    bundle_binding.f25_r_bundle_manifest_file_sha256;
provenance.f25_x_bundle_manifest_file_sha256 = ...
    bundle_binding.f25_x_bundle_manifest_file_sha256;
...
completed = local_resume_inventory( ...
    run_folder, run_folder_observation, config, state, identity, provenance);
...
case_info = struct();
case_info.schema = 'f25-generation-case-info-v2';
...
case_info.bundle_source_binding_schema = ...
    provenance.bundle_source_binding_schema;
case_info.bundle_source_binding_sha256 = ...
    provenance.bundle_source_binding_sha256;
case_info.bundle_source_commit = provenance.bundle_source_commit;
case_info.bundle_source_manifest_sha256 = ...
    provenance.bundle_source_manifest_sha256;
case_info.bundle_source_root_sha256 = ...
    provenance.bundle_source_root_sha256;
case_info.f25_r_bundle_manifest_file_sha256 = ...
    provenance.f25_r_bundle_manifest_file_sha256;
case_info.f25_x_bundle_manifest_file_sha256 = ...
    provenance.f25_x_bundle_manifest_file_sha256;
...
if isfile(case_path) || isfile(damage_path)
    ...
    if ~isfield(previous, 'case_info') || ...
            ~isstruct(previous.case_info) || ...
            ~isscalar(previous.case_info) || ...
            ~isequaln(previous.case_info, case_info) || ...
...
function completed = local_resume_inventory( ...
        run_folder, observation, config, state, identity, provenance)
...
for state_index = 1:state.n_states
    ...
    stamps = load(path, 'file_f25_schema', 'file_gen_fingerprint', ...
        ...
        'file_matlab_environment_descriptor', ...
        'file_matlab_environment_sha256', ...
        'file_generator_source_root_sha256', ...
        'file_bundle_source_binding_sha256');
    ...
    if ~all(isfield(stamps, required)) || ...
            ...
            ~strcmp(stamps.file_matlab_environment_descriptor, ...
                provenance.actual_matlab_environment_descriptor) || ...
            ~strcmp(stamps.file_matlab_environment_sha256, ...
                provenance.actual_matlab_environment_sha256) || ...
            ~strcmp(stamps.file_generator_source_root_sha256, ...
                provenance.generator_source_root_sha256) || ...
            ~strcmp(stamps.file_bundle_source_binding_sha256, ...
                provenance.bundle_source_binding_sha256) || ...
