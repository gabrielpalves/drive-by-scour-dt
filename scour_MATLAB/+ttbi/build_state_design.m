...
if strcmp(profile_mode, 'fixed') && ~strcmp(profile_draw, 'fixed_shared')
    error(['A00: fixed production profiles require ' ...
        'profile_draw=''fixed_shared'' so the provenance cannot imply a ' ...
        'per-state redraw.']);
end
