...
TURNKEY: run once, no manual editing. The script
    ...
    3. Phase 2 - the best pair x the active architectures.
...
(bearing head at Stage 1; scale + EOV at Stage 2), never the backbone too.
...
STAGE = "stage0_multiscour"   # stage0_multiscour | stage1_bearing | stage2_4span | stage3_alldamage
...
if STAGE == "stage0_multiscour":
    ...
    # A00 STAGE='stage3_alldamage' -> Stage-1 bridge/targets + crack + psd_fra
    # + track-layer damage (ballast patches, hanging sleepers, pads) + wheel
    # OOR. All nuisances (logged, not labels); heads identical to Stage 1.
    # states267 = 17 anchors + 250 LHS; CONFIRM against the folder A00 writes.
    DATASET         = "L60_3span_multi_scour_scourS2-3_bearTGT_crackON_prof-psd_fra_trackEOV_oorON_dano0-60pct_states267_Npass50_varNVST"  # CONFIRM
    TARGET_SUPPORTS = [2, 3]
    BEARING_TARGETS = ["left", "right"]
elif STAGE == "stage2_4span":
    # A00 STAGE='stage2_4span' -> L=99.6 m / 4 spans of 24.9 m (grid-exact: all
    # supports on mesh nodes), internal piers 2,3,4 + bearing, with crack +
    # rail-profile (FRA-PSD) EOV nuisances ON.
    ...
    DATASET         = "L99.6_4span_multi_scour_scourS2-3-4_bearTGT_crackON_prof-psd_fra_dano0-60pct_states271_Npass50_varNVST"  # CONFIRM
