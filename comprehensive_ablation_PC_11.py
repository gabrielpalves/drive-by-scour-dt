"""
comprehensive_ablation_PC_11.py
===============================

Drives the long-running comprehensive ablation on PC_11. Splits the 4-arch
grid with PC_7 (this PC owns *PAA + LSTM + N-HiTS* and
*PAA + S2V + LSTM + N-HiTS*).
...
its name, e.g.
    ...
    PAA_S2V_LSTM_NHiTS_DOFs_4_6_seed1337
...
# =============================================================================
#  Configuration — keep this block in sync with comprehensive_ablation_PC_7.py
# =============================================================================
...
# This PC owns the 2 architectures with LSTM.
ARCHITECTURES = [
    {
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 64)
    print("  PC_11 comprehensive ablation finished.")
    print("=" * 64)
